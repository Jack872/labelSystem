...
//    本地路径
    private static final String BASE_PATH = "F:/PG-project/labelMark/src/main";
//    private static final String BASE_PATH = "/home/luu/Backend";
    private static final String TEMP_DIR = BASE_PATH + File.separator + "resource" + File.separator + "temp";

    private static final String UPLOAD_DIR = BASE_PATH + File.separator + "resource" + File.separator + "output";
